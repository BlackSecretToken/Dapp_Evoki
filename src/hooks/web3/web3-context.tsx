...
export const Web3ContextProvider: React.FC<{ children: ReactElement }> = ({ children }) => {
        ...
        new Web3Modal({
            ...
            providerOptions: {
                injected: {
                    display: {
                        name: "Metamask",
                        description: "connect to your MetaMask, BitKeep, Trust Wallet here"
                    },
                    package: null
                },                
                walletconnect: {
    ...
    const connect = useCallback(async () => {
        ...
        const bnbBalance = ethers.utils.formatEther(await connectedProvider.getBalance(connectedAddress));
    ...
    const onChainProvider = useMemo(
        ...
        [connect, disconnect, hasCachedProvider, provider, connected, address, balance, chainID, web3Modal, providerChainID],
    );
    //@ts-ignore
